...
# ))
# 
# install.packages(c("sandpaper", "varnish"))

# install.packages(c("tidyverse", "here", "lubridate", "mapview", "sf"))
```
...
library(here) # help access files on your computer

```
```{r, message=FALSE}
here::i_am('episodes/1_intro_data_analysis.Rmd')
